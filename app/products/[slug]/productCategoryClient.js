...
function ProductCategoryClient({ category, products }) {
  ...
  return (
    <BgLayout>
      {/* Hero Section */}
      <section className='relative h-[60vh] mt-15 flex items-center justify-center overflow-hidden'>
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleFormSubmit} className='space-y-4'>
                ...
                <button
                  type='submit'
                  className='w-full bg-[#297074] hover:bg-[#075056] text-white font-bold py-4 rounded-lg transition-all duration-300'
                >
                  Submit Request
                </button>
              </form>
